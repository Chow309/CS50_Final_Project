...
Enter a number to choose the number of team joining the tournament .
...
Enter the rating for each team to simulate the win rate.
...
Enter the name of team you want to adjust. And choose what do you want adjust. Repeated name will be rejected.
...
Enter the number to simulate a new tournament with new set of data or teriminate the program
